                    ...
                    <div v-if="open.status" class="absolute z-50 mt-2 rounded-[8px] border border-[#00beec26]
                      ...
                      overflow-hidden w-[200px]">
                       ...
                       text-[#0A6B7A] dark:text-[#8ED7E4] hover:bg-[#EAF8FB] dark:hover:bg-[#0D2C31]">
                            ...
                            <button v-for="(opt, i) in options.status" :key="opt" @click="select('status', opt)" class="w-full text-left px-4 py-2 text-[14px] text-[#0C3E45] dark:text-[#A9F3FF]
                    ...
                    <div v-if="open.clients" class="absolute z-50 mt-2 rounded-[8px] border border-[#00beec26]
                      ...
                      overflow-hidden w-[200px]">
                       ...
                       text-[#0A6B7A] dark:text-[#8ED7E4] hover:bg-[#EAF8FB] dark:hover:bg-[#0D2C31]">
                            ...
                            <div class="border-b border-[#00beec14] dark:border-[#00beec1f]"></div>
                            <button v-for="(opt, i) in options.clients" :key="opt" @click="select('clients', opt)" class="w-full text-left px-4 py-2 text-[14px] text-[#0C3E45] dark:text-[#A9F3FF]
                       hover:bg-[#EAF8FB] dark:hover:bg-[#0D2C31]">
                                {{ opt }}
                            </button>
                        </div>
        ...
        <div class="px-5 sm:px-3 mx-5">
            <div v-for="t in pagedTokens" :key="t.id"
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div class="relative w-[110px] h-[16px] rounded-full bg-black/10 dark:bg-white/10 overflow-hidden">
                ...
                <div class="flex justify-end gap-2">
                    <button
                        class="flex items-center justify-center w-8 h-8 rounded-full bg-[#00BEEC1A] border border-[#00BEEC33]">
