<template>
    <main class="bg-light-bg dark:bg-dark-bg min-h-screen text-black dark:text-white overflow-y-hidden">
        ...
        <div class="bg-light-bg dark:bg-transparent p-3 sm:p-4 md:p-6 w-full">
            <div class="min-h-screen text-black dark:text-white space-y-4 sm:space-y-6">
                <section class="grid grid-cols-1 lg:grid-cols-2 gap-3 sm:gap-4">
                    <div
                        class="bg-light-bg dark:bg-[#FFFFFF0D] dark:border dark:border-[#00BEEC66] p-3 sm:p-4 md:p-5 rounded-[17px] shadow-md relative">
                        ...
                        <div class="flex flex-col sm:flex-row sm:justify-between flex-wrap gap-4 sm:gap-6">
                            <div class="text-center flex items-center gap-2 sm:gap-3 p-2 sm:p-3 pl-0 pb-0 rounded-t-xl">
                                <div
                                    class="w-8 h-8 sm:w-10 sm:h-10 flex justify-center items-center border border-white/10 rounded-full bg-light-bg/10">
                                    <img src="../../images/client-portal/avtar-1.png" alt="Avatar"
                                        class="w-6 h-6 sm:w-8 sm:h-8" />
                                </div>
                                <div class="text-left">
                                    <h4
                                        class="font-medium text-[14px] sm:text-[16px] text-black dark:text-[#fff] leading-normal">
                                        Profile picture
                                    </h4>
                                    <p
                            ...
                            <div class="flex gap-2 sm:gap-4">
                                <div class="flex items-center">
                                    <button id="delete" type="button" @click="showDeletePopup = true"
                                        ...
                                        <span><img src="../../images/client-portal/bin-red.svg" alt="bin red"
                                                class="w-3 h-3 sm:w-4 sm:h-4" /></span>
                                        Delete
                                    </button>
                                </div>
                                ...
                                <div class="flex items-center">
                                    <button id="delete" type="button"
                                        ...
                                        <span><img src="../../images/client-portal/media.svg" alt="Update"
                                                class="w-3 h-3 sm:w-4 sm:h-4" /></span>
                                        Upload
                                    </button>
                                </div>
                    ...
                    <form class="pt-4 sm:pt-6 md:pt-7">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-4">
                            ...
                            <div class="mb-2 new-pass">
                                ...
                                <p class="block text-[10px] sm:text-[12px] text-black dark:text-white/50 mb-1 mt-2"
                                    for="newPass">
                            ...
                            <div class="mb-2">
                                ...
                                <div class="relative">
                                    <input type="password" id="cnfNewPass" name="cnfNewPass"
                                        ...
                                        class="bg-transparent w-full px-3 py-2 text-[16px] font-medium border dark:border-white/50 rounded-md focus:outline-none focus:ring-2 focus:ring-cyan-500 pr-7" />
                                    <img class="absolute right-2 top-2 "
                                        src="../../images/client-portal/eye.svg" alt="eye">
                                </div>
                            </div>
                        </div>
