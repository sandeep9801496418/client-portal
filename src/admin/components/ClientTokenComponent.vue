<template>
    ...
    <div ref="filtersRef" class="relative z-40 w-full mx-auto px-3 sm:px-4 md:px-6 lg:px-8 py-4 sm:py-5 md:py-6">
        <div class="flex flex-col sm:flex-row sm:flex-wrap items-start sm:items-center gap-3 sm:gap-4 justify-between">
            <!-- LEFT: search -->
    ...
    <section class=" rounded-2xl border z-10
        ...
        <div class="px-1 sm:px-3 md:px-5 mx-3 sm:mx-4 md:mx-5 min-w-[800px]">
            <div v-for="t in pagedTokens" :key="t.id"
                ...
                <div class="min-w-[120px]">
                    ...
                    <div class="text-[11px] sm:text-[12px] md:text-[13px] opacity-70">{{ t.token }}</div>
                </div>
        ...
        <!-- Footer / pagination -->
        <div
            class="flex flex-col sm:flex-row items-center justify-between px-3 sm:px-4 md:px-5 py-3 sm:py-4 border-[#00beec3d] dark:border-[#00beec26] rounded-b-2xl gap-3 sm:gap-0">
