        ...
        <header class="px-4 sm:px-6 py-4 sm:py-5 border-b border-[rgba(0,190,236,0.30)]">
            <div class="flex items-center justify-between">
                <div class="flex flex-col sm:flex-row sm:items-end gap-1 sm:gap-4">
                    <h1 class="font-inter text-[18px] sm:text-[22px] md:text-[30px] font-medium leading-none">Users Management</h1>
                    <p class="text-[11px] sm:text-[13px] md:text-[15px] text-[#00BEEC99]">May 17, 2025 | Saturday</p>
                </div>
            ...
            <section v-if="activeTab === 'details'" class="mt-4 sm:mt-6">
                ...
                <div class="rounded-xl border border-black/10 dark:border-[#00BEEC66] overflow-hidden">
                   ...
                   ">
                        ...
                        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 sm:gap-0 mt-4 sm:mt-6">
                            ...
                            <div class="flex items-center gap-3 sm:gap-4">
                                ...
                                <div>
                                    <p class="font-inter text-[14px] sm:text-[16px] font-[500px]">{{ user.name }}</p>
                                    <p class="font-inter text-xs sm:text-sm text-black/60 dark:text-white/60">{{ user.email }}</p>
                                </div>
                            </div>
                            <span
                                class="px-2 sm:px-3 py-1 rounded-full text-xs sm:text-sm text-white bg-[#C300FF] dark:bg-[#C300FF26] dark:text-[#C300FF] self-start sm:self-auto">Manager</span>
                        </div>
                ...
                <!-- KPIs -->
                <div class="mt-6 sm:mt-8 flex justify-center gap-4 sm:gap-8 md:gap-12 flex-wrap">
                    <div class="rounded-2xl px-4 sm:px-6 py-6 sm:py-8 text-center w-full sm:w-[200px] md:w-[260px]
                      bg-[#0D3A43]/5 text-[#0C3E45]
                      dark:bg-[#00BEEC30] dark:text-white">
                        <div class="text-2xl sm:text-3xl md:text-4xl font-semibold leading-none mb-2">{{ stats.tokens }}</div>
                    ...
                    <div class="rounded-2xl px-4 sm:px-6 py-6 sm:py-8 text-center w-full sm:w-[200px] md:w-[260px]
                      bg-[#0D3A43]/5 text-[#0C3E45]
                      dark:bg-[#00BEEC30] dark:text-white">
                        <div class="text-2xl sm:text-3xl md:text-4xl font-semibold leading-none mb-2">{{ stats.quota }}%</div>
                    ...
                    <div class="rounded-2xl px-4 sm:px-6 py-6 sm:py-8 text-center w-full sm:w-[200px] md:w-[260px]
                      bg-[#0D3A43]/5 text-[#0C3E45]
                      dark:bg-[#00BEEC30] dark:text-white">
                        <div class="text-2xl sm:text-3xl md:text-4xl font-semibold leading-none mb-2">{{ stats.days }}</div>
